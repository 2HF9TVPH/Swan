...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/2HF9TVPH/Swan/master/Swan-libev-debian"
}
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://teddysun.com/548.html and good luck."
        exit 1
    fi
